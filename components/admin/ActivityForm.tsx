                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full px-8 py-5 bg-white/[0.03] border border-white/10 rounded-2xl outline-none focus:border-gold/50 transition-all font-black text-white appearance-none text-xs uppercase tracking-widest"
                                >
                        ...
                        <div className="space-y-4">
                            ...
                            <input
                                type="date"
                                required
                                className="w-full px-8 py-5 bg-white/[0.03] border border-white/10 rounded-2xl outline-none focus:border-gold/50 transition-all font-black text-white text-xs uppercase tracking-widest"
                                value={formData.date}
